...
const T = {
  cs: {
    ...
    fGdprA: 'Souhlasím se ', fGdprLink: 'zpracováním osobních údajů', fGdprHref: '/souhlas-s-poskytnutim-osobnich-udaju/',
    ...
    legalPrivacy: 'Ochrana osobních údajů', privacyHref: '/souhlas-s-poskytnutim-osobnich-udaju/',
